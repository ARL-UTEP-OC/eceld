...
public class ClicksToJSON {
	...
	public static void main(String args[]) {
		...
		try {
			...
			System.out.println("Parsing click data");
			String answer = "[\n";
			...
			if (directoryListing != null && directoryListing.length > 0) {
    			...
    			System.out.println("\tNo click data items found");

		answer += "]";
		System.out.println("\tFinished parsing click data");
        FileOutput.WriteToFile(outputPath + "/click.JSON", answer);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
